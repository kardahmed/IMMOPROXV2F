      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div><Label className={labelClass}>Nom de l'agence *</Label><Input value={name} onChange={e => setName(e.target.value)} placeholder="Nom..." variant="immo" /></div>
            <div><Label className={labelClass}>Email *</Label><Input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="email@..." variant="immo" /></div>
            <div><Label className={labelClass}>Telephone</Label><Input value={phone} onChange={e => setPhone(e.target.value)} placeholder="0xxx..." variant="immo" /></div>
            <div>
            ...
            <div><Label className={labelClass}>Adresse</Label><Input value={address} onChange={e => setAddress(e.target.value)} variant="immo" /></div>
            <div><Label className={labelClass}>Site web</Label><Input value={website} onChange={e => setWebsite(e.target.value)} variant="immo" /></div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div><Label className={labelClass}>Prenom *</Label><Input value={adminFirstName} onChange={e => setAdminFirstName(e.target.value)} variant="immo" /></div>
            <div><Label className={labelClass}>Nom *</Label><Input value={adminLastName} onChange={e => setAdminLastName(e.target.value)} variant="immo" /></div>
            <div className="col-span-2"><Label className={labelClass}>Email Admin *</Label><Input type="email" value={adminEmail} onChange={e => setAdminEmail(e.target.value)} placeholder="admin@agence.com" variant="immo" /></div>
          </div>
        </div>
      </div>
    </Modal>
