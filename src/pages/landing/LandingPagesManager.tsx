            ...
            return (
              <div key={page.id} className="flex items-center gap-4 rounded-xl border border-immo-border-default bg-immo-bg-card p-4 shadow-sm">
                ...
                <div className="flex items-center gap-1">
                  <button onClick={() => copyLink(page.slug)} aria-label="Copier le lien" title="Copier le lien" className="rounded-md p-2 text-immo-text-muted transition-colors hover:bg-immo-bg-card-hover hover:text-immo-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0579DA]/40">
                    <Copy className="h-4 w-4" />
                  </button>
                  <a href={`/p/${page.slug}`} target="_blank" rel="noopener noreferrer" aria-label="Voir la page" title="Voir" className="rounded-md p-2 text-immo-text-muted transition-colors hover:bg-immo-bg-card-hover hover:text-immo-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0579DA]/40">
                    <ExternalLink className="h-4 w-4" />
                  </a>
                  <button onClick={() => { setEditPage(page); setShowEditor(true) }} aria-label="Modifier la page" title="Modifier" className="rounded-md p-2 text-immo-text-muted transition-colors hover:bg-immo-bg-card-hover hover:text-immo-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0579DA]/40">
                    <Pencil className="h-4 w-4" />
                  </button>
                  <button onClick={() => toggleActive.mutate({ id: page.id, active: !page.is_active })} aria-label={page.is_active ? 'Desactiver la page' : 'Activer la page'} title={page.is_active ? 'Desactiver' : 'Activer'} className="rounded-md p-2 text-immo-text-muted transition-colors hover:bg-immo-bg-card-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0579DA]/40">
