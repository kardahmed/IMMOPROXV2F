export const ar = {
  ...
  tenant_form: {
    ...
    section_company: 'معلومات الشركة',
    section_plan: 'الخطة وفترة التجربة',
    section_admin: 'مسؤول المستأجر',
    agency_name: 'اسم الوكالة',
    agency_name_placeholder: 'مثال: ETOILE IMMO',
    email: 'البريد الإلكتروني',
    phone: 'الهاتف',
    wilaya: 'الولاية',
    select: 'اختر',
    ...
    plan: 'الخطة',
    trial_days: 'فترة التجربة (أيام)',
    trial_days_hint: '0 = بدون فترة تجربة، 14 = افتراضي',
    admin_invite_note: 'سيتم إرسال بريد دعوة إلى هذا المسؤول',
    first_name: 'الاسم',
    last_name: 'اللقب',
    ...
    created_success: 'تم إنشاء المستأجر "{{name}}". تم إرسال الدعوة إلى {{email}}',
    error_generic: 'خطأ أثناء الإنشاء',
    confirm_cancel_title: 'التخلي عن الإنشاء؟',
    confirm_cancel_desc: 'سيتم فقدان جميع المعلومات المدخلة. هذا الإجراء لا رجعة فيه.',
    confirm_cancel_yes: 'تخلي',
  },
  ...
  settings_page: {
    ...
    section_call_scripts: 'سكريبتات المكالمات',
