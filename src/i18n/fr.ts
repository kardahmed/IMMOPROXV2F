export const fr = {
  ...
  pipeline_page: {
    ...
    tab_analytics: 'Répartition par étape',
    filter_active: 'Filtre actif : {{count}} client(s)',
    clear_filter: 'Effacer',
    kpi_clients: 'Clients',
    kpi_pending_visits: 'Visites en attente',
    kpi_in_negotiation: 'En négociation',
    kpi_converted: 'Convertis',
    kpi_total_potential: 'Potentiel total',
    kpi_negotiation_value: 'En négo DA',
    kpi_converted_value: 'Valeur convertie',
    kpi_avg_budget: 'Budget moyen',
    ...
    view_table: 'Tableau',
    btn_client: 'Client',
    selected_count: '{{count}} client(s)',
    deselect_all: 'Désélectionner tout',
    reassign_to: 'Réassigner à…',
    reassign_action: 'Réassigner',
    reassign_success: '{{count}} client(s) réassigné(s)',
    yes: 'Oui',
    no: 'Non',
  },
  ...
  sale_modal: {
    ...
    frequency: 'Fréquence des versements',
    down_payment: 'Apport initial',
    first_payment_date: 'Date du premier versement',
    ready_to_finalize: 'Prêt à finaliser',
    section_identification: 'Identification',
    section_selected_units: 'Biens sélectionnés',
    discount_label: 'Remise',
    total_label: 'Total',
    section_schedule: 'Échéancier',
    first_installment: 'Premier versement',
    last_installment: 'Dernier versement',
    section_documents: 'Documents à générer',
    preview: 'Aperçu',
    download: 'Télécharger',
    print: 'Imprimer',
    section_internal_notes: 'Notes internes',
    notes_placeholder: 'Notes internes sur cette vente…',
    amenity_placeholder: 'Cuisine équipée haut de gamme',
  },

  // Create reservation modal
  reservation_modal: {
    title: 'Créer une réservation',
    info_banner: "Sélectionnez les unités à réserver, renseignez le NIN et téléchargez la carte d'identité. Les unités seront marquées comme réservées.",
    project: 'Projet *',
    select_project: 'Sélectionner le projet',
    available_units: 'Unités disponibles *',
    units_selected: '{{count}} unité(s) sélectionnée(s)',
    select_project_first: 'Sélectionnez un projet',
    no_units_available: 'Aucune unité disponible',
    nin_cin: 'NIN / CIN *',
    nin_cin_placeholder: "Numéro d'identité nationale",
    duration: 'Durée de réservation',
    duration_15: '15 jours',
    duration_30: '30 jours',
    duration_60: '60 jours',
    duration_hint: 'La réservation expirera automatiquement après cette période',
    cin_card: "Carte Nationale d'Identité *",
    file_size_hint: 'JPG, PNG, WebP ou PDF — max 5 Mo',
    ...
    payment_reference_placeholder: 'N° virement ou chèque',
    summary_units_days: '{{count}} unité(s) · {{days}} jours',
    total: 'Total : {{amount}}',
    deposit: 'Acompte',
    cancel: 'Annuler',
  ...
  client_form: {
    ...
    add_subtitle: 'Ajouter un client au pipeline',
    section_identity: 'Identité',
    section_commercial: 'Commercial',
    section_assignment: 'Assignation',
    full_name: 'Nom complet *',
    full_name_placeholder: 'Ahmed Kardjadja',
    phone: 'Téléphone *',
    phone_placeholder: '0555 123 456',
    email: 'Email',
    email_placeholder: 'ahmed@email.com',
    nin_cin: 'NIN / CIN',
    nin_cin_placeholder: 'Numéro identité',
    client_type: 'Type client',
    individual: 'Particulier',
    company: 'Entreprise',
    birth_date: 'Date de naissance',
    nationality: 'Nationalité',
    nationality_placeholder: 'Algérienne',
    source: 'Source *',
    marketing_campaign: 'Campagne marketing',
    no_campaign: '— Aucune —',
    paused_suffix: ' (en pause)',
    interested_projects: "Projets d'intérêt",
    no_projects: 'Aucun projet',
    desired_unit_types: "Types d'unités souhaitées",
    confirmed_budget: 'Budget confirmé (DA)',
    confirmed_budget_placeholder: '12000000',
    interest_level: "Niveau d'intérêt",
    payment_method: 'Modalités de paiement',
    assigned_agent: 'Agent assigné *',
    profession: 'Profession',
    profession_placeholder: 'Ingénieur, Commerçant…',
    address: 'Adresse',
    address_placeholder: 'Alger, Hydra',
    notes: 'Notes',
    notes_placeholder: 'Notes libres sur ce client…',
    cancel: 'Annuler',
    save: 'Enregistrer',
