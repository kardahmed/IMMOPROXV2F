...
export function NotificationBell() {
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      {open && (
        <div className="fixed right-2 top-14 z-50 w-[calc(100vw-1rem)] max-w-[360px] rounded-xl border border-immo-border-default bg-immo-bg-card shadow-lg sm:absolute sm:right-0 sm:top-full sm:mt-2 sm:w-[360px]">
